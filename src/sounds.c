...
unsigned char sfx_chestopen[30]= {
    SND_STEP_Vol,15,
    SND_STEP_VolumePassFilter,31,
    SND_STEP_ResonanceBits,1,
    SND_STEP_V1PlHigh,8,
    SND_STEP_V1AttDec,0,
    SND_STEP_V1SusRel,200,
    SND_STEP_V1PiHigh,20,
    SND_STEP_V1PiLow,15,
    SND_STEP_V1Wav,SND_WAV_BITS_NOISE,
    SND_STEP_RiseValue,32,
    SND_STEP_CutoffLow,16,
    SND_STEP_FallValue,64,
    SND_STEP_CutoffHigh,16,
    SND_STEP_End
...
unsigned char sfx_test[100]= {
    SND_STEP_V1PulseWidthLow,128,
    SND_STEP_V1PulseWidthHigh,7,
    SND_STEP_V1AttDec,79,
    SND_STEP_V1SusRel,248,
    SND_STEP_V2PulseWidthLow,128,
    SND_STEP_V2PulseWidthHigh,7,
    SND_STEP_V2AttDec,79,
    SND_STEP_V2SusRel,248,
    SND_STEP_V3PulseWidthLow,128,
    SND_STEP_V3PulseWidthHigh,8,
    SND_STEP_V2AttDec,79,
    SND_STEP_V3SusRel,248,
    SND_STEP_Vol,15,
    SND_STEP_End
};
...
unsigned char sfx_slidedown[200]= {
    SND_STEP_V1SusRel,240,
    SND_STEP_V2PlHigh,8,
    SND_STEP_V2SusRel,240,
    SND_STEP_V2PlHigh,8,
    ...
    SND_STEP_V1Wav,65,
    SND_STEP_V2Wav,65,
    SND_STEP_V3Wav,SND_WAV_BITS_SAW,

    SND_STEP_Vol,15,
    SND_STEP_V1PiLow,97,
    SND_STEP_V1PiHigh,20,
    SND_STEP_V2PiLow,97,
    SND_STEP_V2PiHigh,20,
    SND_STEP_V3PiLow,97,
    SND_STEP_V3PiHigh,20,
    SND_STEP_Wait,255,
    SND_STEP_Wait,255,
    ...
    SND_STEP_V1PiLow,44,
    SND_STEP_V1PiHigh,44,
    SND_STEP_V2PiLow,48,
    SND_STEP_V2PiHigh,48,
    SND_STEP_V3PiLow,50,
    SND_STEP_V3PiHigh,50,
    SND_STEP_Wait,255,
    SND_STEP_Wait,255,
    ...
    SND_STEP_V2PiLow,37,
    SND_STEP_V2PiHigh,37,
    SND_STEP_V3PiLow,45,
    SND_STEP_V3PiHigh,45,
    SND_STEP_Wait,255,
    SND_STEP_Wait,255,

    SND_STEP_V1PiLow,25,
    SND_STEP_V1PiHigh,25,
    SND_STEP_V2PiLow,30,
    SND_STEP_V2PiHigh,30,
    SND_STEP_V3PiLow,30,
    SND_STEP_V3PiHigh,30,
    SND_STEP_Wait,255,
    SND_STEP_Wait,255,
